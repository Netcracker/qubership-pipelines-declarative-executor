...
### Remote Delivery Params

| Name                                                       | Default Value | Comment                                                                                                        |
|------------------------------------------------------------|:-------------:|----------------------------------------------------------------------------------------------------------------|
| PIPELINES_DECLARATIVE_EXECUTOR_REMOTE_DELIVERIES_FILE_PATH |     None      | Path to file with JSON array of remote delivery configs (checked first)                                        |
| PIPELINES_DECLARATIVE_EXECUTOR_REMOTE_DELIVERIES           |     None      | JSON array of remote delivery configs (sample is in [config examples](./config_examples.md#remote_deliveries)) |
